...
class OtpMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Your {$this->hotelName} Password Reset Code",
        );
    }
    ...
    <tr><td align="center">
      <table width="500" cellpadding="0" cellspacing="0" style="background-color:#1a2d47;border-radius:16px;overflow:hidden;border:1px solid rgba(192,160,98,0.15);">
        ...
        <tr><td style="padding:20px 40px;">
          <h2 style="color:#ffffff;font-size:20px;font-weight:400;margin:0 0 12px;text-align:center;">Password Reset Code</h2>
          ...
          <p style="color:rgba(255,255,255,0.4);font-size:13px;text-align:center;margin:0 0 8px;">This code expires in <strong style="color:rgba(255,255,255,0.6);">15 minutes</strong>.</p>
