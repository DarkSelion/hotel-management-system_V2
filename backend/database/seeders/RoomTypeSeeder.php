...
class RoomTypeSeeder extends Seeder
{
    public function run(): void
    {
        $roomTypes = [
            ...
            ['name' => 'Family Room', 'slug' => 'family-room', 'description' => 'Spacious family room with Queen and Twin beds', 'base_price' => 200, 'capacity' => 4, 'size_sqm' => 45, 'bed_type' => 'Queen + Twin', 'max_adults' => 4, 'max_children' => 2, 'is_active' => true, 'sort_order' => 6],
        ];
