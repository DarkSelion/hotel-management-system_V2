...
const RoomImagesPage = lazy(() => import('./pages/RoomImagesPage'))

const PortalHomePage = lazy(() => import('./pages/portal/PortalHomePage'))
const PortalRoomsPage = lazy(() => import('./pages/portal/PortalRoomsPage'))
const PortalRoomDetailPage = lazy(() => import('./pages/portal/PortalRoomDetailPage'))
...
const PortalMyReservationsPage = lazy(() => import('./pages/portal/PortalMyReservationsPage'))
const PortalProfilePage = lazy(() => import('./pages/portal/PortalProfilePage'))
const PortalGalleryPage = lazy(() => import('./pages/portal/PortalGalleryPage'))
