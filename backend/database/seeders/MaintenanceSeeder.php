...
class MaintenanceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $requests = [
            [
                'room_id' => $rooms['104']->id, 'reported_by' => 3, 'assigned_to' => 2,
            ...
            [
                'room_id' => $rooms['207']->id, 'reported_by' => 4, 'assigned_to' => 2,
            ...
            [
                'room_id' => $rooms['310']->id, 'reported_by' => 2, 'assigned_to' => null,
                ...
                'category' => 'elevator', 'priority' => 'urgent', 'status' => 'open',
                'estimated_cost' => 2000.00, 'actual_cost' => null,
                'completed_at' => null, 'notes' => 'Elevator company notified',
            ],
            [
                'room_id' => $rooms['101']->id, 'reported_by' => 3, 'assigned_to' => 2,
            ...
            [
                'room_id' => $rooms['108']->id, 'reported_by' => 4, 'assigned_to' => 2,
                'title' => 'TV not working',
                'description' => 'Smart TV in room 108 will not turn on. Power indicator light is off.',
                'category' => 'electronics', 'priority' => 'medium', 'status' => 'pending',
